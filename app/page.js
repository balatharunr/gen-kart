    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className={`lg:hidden fixed top-0 left-0 h-full w-64 bg-white shadow-lg z-[60] transform transition-transform duration-300 ease-in-out ${
        ...
        <div className="absolute bottom-4 left-4 right-4">
          <button className="w-full flex items-center justify-center space-x-2 bg-blue-900 text-white px-4 py-3 rounded-md hover:bg-blue-800 transition font-medium">
        ...
        <div className="max-w-7xl mx-auto pl-2 pr-4 sm:pl-4 sm:pr-6 lg:pl-6 lg:pr-8">
          <div className="flex items-center justify-between h-16 lg:h-28">
            ...
            <div className="flex items-center space-x-2 lg:space-x-4">
              ...
              <button className="hidden lg:flex items-center space-x-2 bg-blue-900 text-white px-6 py-2.5 rounded-md hover:bg-blue-800 transition font-medium">
                <svg className="w-5 h-5" viewBox="0 0 24 24">
                  <path
                    fill="currentColor"
                    d="M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92c-.26 1.37-1.04 2.53-2.21 3.31v2.77h3.57c2.08-1.92 3.28-4.74 3.28-8.09z"
              ...
              <button className="relative p-1 lg:p-2 hover:bg-gray-100 rounded-full transition">
                <Image
